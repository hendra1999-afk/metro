...
<button type="button" class="popup-btn popup-btn-collect" onmousedown="buka.play()" onclick="account_login()"><span>Collect</span></button>
</div>
</div>
...
<img style="width: 50px; margin-top: 10px; margin-left: auto; margin-right: auto; border: 3px solid #000; border-radius: 50%; display: block;" src="https://www.pubgmobile.com/common/images/icon_logo.jpg">
<div class="popup-alert">Log in using your account to receive rewards</div>
